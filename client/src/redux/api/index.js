...
export const checkEmail = (email) => API.get(`/user/check-email?email=${encodeURIComponent(email)}`)
export const checkUsername = (username) => API.get(`/user/check-username?username=${encodeURIComponent(username)}`)
