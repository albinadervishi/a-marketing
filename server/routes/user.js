...
import { getUsers, getUser, getEmployeeClients, filterUser, createClient, createEmployee, updateUser, updateRole, deleteUser, getClients, getEmployees, deleteWholeCollection, checkEmail, checkUsername } from '../controllers/user.js'
import { verifyManager, verifyEmployee, verifyToken, verifySuperAdmin, verifyIsSameUser } from '../middleware/auth.js'
import { validate } from '../middleware/validate.js'
import { createClientSchema, createEmployeeSchema, updateUserSchema } from '../utils/schemas.js'
...
// PUT
router.put('/update/:userId', verifyToken, verifyManager, validate(updateUserSchema), updateUser)
